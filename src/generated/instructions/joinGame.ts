...
export type JoinGameInstructionDataArgs = { color: ColorsArgs };
...
> = {
  ...
  color: JoinGameInstructionDataArgs['color'];
};
...
>(
  input: JoinGameInput<TAccountPlayer, TAccountGame>,
  config?: { programAddress?: TProgramAddress }
): JoinGameInstruction<TProgramAddress, TAccountPlayer, TAccountGame> {
  // Program address.
  ...
  } as JoinGameInstruction<TProgramAddress, TAccountPlayer, TAccountGame>;
